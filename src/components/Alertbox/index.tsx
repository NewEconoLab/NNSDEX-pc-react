      ...
      <div className="comp-alert-container">
        ...
        <div className={this.props.type ? this.props.type : 'alert-wrapper'}>
          ...
          <div className="alert-img">
            {
              this.props.imgFlag === AlertType.bonus && <img src={require('@/img/icon-bonus.png')} alt=""/>
            } 
            {
              this.props.imgFlag === AlertType.chest && <img src={require('@/img/icon-chest.png')} alt=""/>
            }
            {
              this.props.imgFlag === AlertType.invatation && <img src={require('@/img/icon-invite.png')} alt=""/>
            }
            {
              this.props.imgFlag === AlertType.lucky && <img src={require('@/img/icon-lucky.png')} alt=""/>
            }
            {
              this.props.imgFlag === AlertType.qa && <img src={require('@/img/icon-qa.png')} alt=""/>
            }
            {
              this.props.imgFlag === AlertType.rank && <img src={require('@/img/icon-rank.png')} alt=""/>
            }           
          </div>
