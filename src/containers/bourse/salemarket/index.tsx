...
@observer
class SaleMarket extends React.Component<any, any> {
  // 筛选条件
  public orderOptions = [
    {
      id: 'no',
  ...
  public onGoDomainInfo = (domain:string,type:string) => {
    this.props.history.push('/saleinfo/'+domain+'?type='+type)
  }
  public render()
  {
    return (
      <div className="sale-page">
        ...
        <div className="sale-table">
          <ul className="table-ul">
            ...
            <li className="table-td" onClick={this.onGoDomainInfo.bind(this,'asdf.neo','salemarket')} >
              <ul className="td-ul">
                <li className="td-li">
